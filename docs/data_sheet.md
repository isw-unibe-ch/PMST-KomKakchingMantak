Data set name: PMST Kakching Mantak Kom

Data set developer(s): Susie Kanshouwa, Anja Karina Meduna, Sandra Auderset

Data sheet author(s): Susie Kanshouwa, Sandra Auderset

Others who contributed to this document: Karung Hoineikham Kom, Karoung Chongneishin Kom, Mangte Ngir Hitler Kom
...
This data set was created to investigate the dynamics of person marking in Kakching Mantak Kom and other South-Central Trans-Himalayan languages.
...
For Kakching Mantak, it is a version of the community orthography used by speakers.

**How many instances are there in total?**

* Number of inflected forms: 294
* Number of unique inflected forms: 105
...
|paradigm |variants_tag            |analysis_tag |overabundance_tag |  n|
|:--------|:-----------------------|:------------|:-----------------|--:|
|pron     |unspecified             |             |                  |  7|
|fut.aff  |dialect_var             |             |                  |  3|
|fut.aff  |sociolect_var           |fusion       |                  |  1|
|fut.aff  |sociolect_var           |             |optional_sap_o    |  5|
|fut.aff  |sociolect_var           |             |                  |  8|
|fut.aff  |unspecified             |             |optional_sap_o    |  1|
|fut.aff  |unspecified             |             |optional_third    |  1|
|fut.aff  |unspecified             |             |                  | 45|
|fut.neg  |formal                  |             |                  | 23|
|fut.neg  |informal                |fusion       |                  | 23|
|fut.neg  |sociolect_var           |fusion       |optional_sap_o    |  2|
|fut.neg  |sociolect_var           |             |optional_sap_o    |  4|
|fut.neg  |sociolect_var           |             |                  |  1|
|fut.neg  |unspecified             |             |                  | 16|
|nfut.aff |sociolect_var           |fusion       |optional_sap_o    |  7|
|nfut.aff |sociolect_var           |fusion       |                  |  3|
|nfut.aff |sociolect_var           |             |optional_sap_o    |  2|
|nfut.aff |sociolect_var           |             |                  | 18|
|nfut.aff |unspecified             |             |optional_sap_o    |  2|
|nfut.aff |unspecified             |             |optional_third    |  2|
|nfut.aff |unspecified             |             |                  | 38|
|nfut.neg |formal                  |             |optional_sap_o    |  1|
|nfut.neg |formal                  |             |                  | 20|
|nfut.neg |informal                |fusion       |                  | 23|
|nfut.neg |informal; sociolect_var |fusion       |                  |  7|
|nfut.neg |sociolect_var           |fusion       |optional_sap_o    |  5|
|nfut.neg |sociolect_var           |             |optional_sap_o    |  4|
|nfut.neg |sociolect_var           |             |                  |  1|
|nfut.neg |unspecified             |fusion       |                  |  2|
|nfut.neg |unspecified             |             |                  | 19|
...
* Glottocode: komi1270
* Language variety description: This is a variety of Kom spoken in Kakching Mantak village, located in Chandel district of Manipur in northeast India. The Glottocode refers to Kom in general, not specifically to the Kakching Mantak variety.

**Does the data pertain to specific dialects, geographical locations, genre, etc?**

The data was collected from Kakching Mantak village. There are six regional varieties in Kom: Mongtung variety, Sinamkom variety, Moirang variety, Mantak variety, Sagang variety, and Tonsen variety. Kakching Mantak belongs to the Mantak variety.
...
The data set pertains to small or indigenous language communities, namely those of the Kakching Mantak Kom people.
...
Karung Hoineikham Kom, Karoung Chongneishin Kom, Mangte Ngir Hitler Kom: native speakers (language consultants)
...
The data was collected predominantly between November 2025 and February 2026.
